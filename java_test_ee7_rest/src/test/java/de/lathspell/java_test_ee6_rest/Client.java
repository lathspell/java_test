...
// The ClientBuilder API is part of JAX-RS 2.0 which is only part of Java EE 7!
...
/**
 * This test uses an already up and running application server.
 */
public class Client {

    private static final String URL = "http://localhost:8080";

    private static final String CONTEXT_PATH = "/java_test_ee7_rest";
